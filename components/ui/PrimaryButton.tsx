...
export const PrimaryButton: React.FC<ButtonProps> = ({ children, className = '', href, variant = 'primary', ...props }) => {
  const baseStyles = "px-8 py-3 font-bold rounded-lg transition-all inline-block text-center focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-400";
