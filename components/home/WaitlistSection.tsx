...
export const WaitlistSection = () => {
  ...
  return (
    ...
    >
      <div className="max-w-3xl w-full md:backdrop-blur-md bg-indigo-950/40 p-6 sm:p-8 md:p-12 rounded-2xl sm:rounded-[2rem] md:rounded-[3rem] border border-slate-800 shadow-[0_0_45px_rgba(79,70,229,0.22)] md:shadow-[0_0_80px_rgba(79,70,229,0.3)] relative overflow-hidden hover:border-slate-700 hover:shadow-[0_0_70px_rgba(79,70,229,0.3)] md:hover:shadow-[0_0_100px_rgba(79,70,229,0.4)] transition-all duration-500">
