export const GameSummarySection = () => {
  return (
    <section className="py-20 px-8 bg-slate-900/50 border-y border-slate-800">
      <div className="max-w-4xl mx-auto text-center">
        <h2 className="text-3xl md:text-4xl font-bold mb-8 text-white">What is Void Count?</h2>
