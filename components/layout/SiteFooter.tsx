      ...
      <div className="max-w-4xl mx-auto flex flex-col gap-6 sm:gap-8 md:gap-10">
        <div className="flex flex-col gap-3 sm:gap-4">
          ...
          <div className="flex flex-wrap justify-center gap-4 sm:gap-6">
            <a href="https://www.instagram.com/voidcountltd?igsh=dHh1bWV5c216YXJ1&utm_source=qr" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 hover:text-purple-300 transition-colors uppercase tracking-widest text-[9px] sm:text-[10px] font-black group">
            ...
            <a href="#" className="flex items-center gap-2 hover:text-purple-300 transition-colors uppercase tracking-widest text-[9px] sm:text-[10px] font-black group">
        ...
        <div>
          <p className="text-xs sm:text-sm">&copy; 2026 Void Count. All rights reserved.</p>
          <p className="mt-1 text-slate-500 text-[9px] sm:text-[10px] uppercase tracking-widest font-medium">
            Version {SITE_VERSION}
          </p>
          <p className="mt-2 text-slate-500 text-[10px] sm:text-xs">
