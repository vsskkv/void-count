...
export const metadata: Metadata = {
  ...
  description:
    "Discover the origins of Void Count, a new card game built for social sabotage and laughs. Learn about this strategic card game and why it's the perfect gift for board game lovers, family game nights, and Kickstarter fans. One of the best new card games launching in 2024.",
  keywords: [
    "about card game",
    "new card game story",
    "card game creators",
      ...
      <div className="pt-20 sm:pt-24 md:pt-32 lg:pt-48 pb-12 sm:pb-16 md:pb-24 px-4 sm:px-6 max-w-6xl mx-auto">
        ...
        <section className="mb-12 sm:mb-16 md:mb-20 lg:mb-32 text-center max-w-4xl mx-auto">
          ...
          <p className="text-base sm:text-lg md:text-xl lg:text-2xl text-slate-300 leading-relaxed font-medium">
            ...
            <span className="italic text-indigo-400"> That</span> idea grew through countless game nights, late-night play sessions, and the shared belief that the best new card games are easy to learn but hard to master.
          </p>
