          ...
          <div className="w-full grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
            ...
            <div className="relative h-[400px] sm:h-[500px] lg:h-[600px] flex items-center justify-center">
              ...
              <div className="relative w-full h-full flex items-center justify-center">
                <img
                  src="/Sabotage v1.png"
                  alt="Sabotage Card"
                  className="absolute w-[45%] max-w-[280px] h-auto rotate-[-12deg] translate-x-[-15%] translate-y-[5%] hover:rotate-[-8deg] hover:scale-110 transition-all duration-300 shadow-[0_20px_60px_rgba(168,85,247,0.4)] rounded-2xl"
                />
                <img
                  src="/Toss v1.png"
                  alt="Toss Card"
                  className="absolute w-[45%] max-w-[280px] h-auto rotate-[0deg] z-10 hover:scale-110 hover:z-20 transition-all duration-300 shadow-[0_25px_70px_rgba(168,85,247,0.5)] rounded-2xl"
                />
                <img
            ...
            <div className="text-left lg:text-right">
              ...
              <div className="flex flex-wrap lg:justify-end gap-2 sm:gap-3 md:gap-4">
                <div className="px-3 sm:px-4 py-2 bg-indigo-500/10 border border-indigo-500/30 rounded-xl text-indigo-300 font-bold text-xs sm:text-sm uppercase backdrop-blur-sm">Quick Rounds</div>
                <div className="px-3 sm:px-4 py-2 bg-purple-500/10 border border-purple-500/30 rounded-xl text-purple-300 font-bold text-xs sm:text-sm uppercase backdrop-blur-sm">Deep Strategy</div>
              </div>
            </div>
          </div>
        </section>
              ...
              <div className="grid grid-cols-1 gap-4 md:gap-6">
                <div className="group bg-slate-900/60 backdrop-blur-sm p-6 sm:p-8 rounded-2xl md:rounded-3xl border border-white/5 hover:border-indigo-500/50 transition-all">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      <h3 className="text-xl sm:text-2xl font-black text-indigo-400 mb-2 uppercase italic">Risk Analysis</h3>
                      <p className="text-slate-300 font-medium text-sm sm:text-base">Is that 10-point card a ladder to victory or a trap waiting to collapse your score?</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="group bg-slate-900/60 backdrop-blur-sm p-6 sm:p-8 rounded-2xl md:rounded-3xl border border-white/5 hover:border-violet-500/50 transition-all">
                  <div className="flex items-start gap-4">
                    <div className="text-3xl sm:text-4xl flex-shrink-0">🎭</div>
                    <div>
                      <h3 className="text-xl sm:text-2xl font-black text-violet-400 mb-2 uppercase italic">Tactical Bluffs</h3>
                      <p className="text-slate-300 font-medium text-sm sm:text-base">Call "Count" when they least expect it. Watch them scramble as the Void claims their points.</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="group bg-gradient-to-r from-indigo-900/40 to-purple-900/40 backdrop-blur-sm p-6 sm:p-8 rounded-2xl md:rounded-3xl border border-indigo-500/30">
                  <div className="flex items-start gap-3 sm:gap-4">
                    ...
                    <div>
                      <h3 className="text-xl sm:text-2xl md:text-3xl font-black text-white uppercase italic tracking-tighter mb-2">Strategic Sabotage</h3>
              ...
              <div className="relative w-full h-full grid grid-cols-2 gap-4 p-4">
                <div className="relative group">
                  <img
                    src="/Eight v1.png"
                    alt="Eight Card"
                    className="w-full h-full object-contain hover:scale-105 transition-transform duration-300 shadow-[0_15px_40px_rgba(99,102,241,0.4)] rounded-xl"
                  />
                  <div className="absolute inset-0 bg-gradient-to-t from-slate-950/80 to-transparent opacity-0 group-hover:opacity-100 transition-opacity rounded-xl flex items-end p-4">
                    <span className="text-white font-bold text-sm">Point Cards</span>
                  </div>
                </div>
                <div className="relative group mt-8">
                  <img
                    src="/Blue Glacier v1.png"
                    alt="Blue Glacier Anomaly"
                    className="w-full h-full object-contain hover:scale-105 transition-transform duration-300 shadow-[0_15px_40px_rgba(99,102,241,0.4)] rounded-xl"
                  />
                  <div className="absolute inset-0 bg-gradient-to-t from-slate-950/80 to-transparent opacity-0 group-hover:opacity-100 transition-opacity rounded-xl flex items-end p-4">
                    <span className="text-white font-bold text-sm">Anomalies</span>
                  </div>
                </div>
                <div className="relative group -mt-8">
                  <img
                    src="/Take Two v1.png"
                    alt="Take Two Power Card"
                    className="w-full h-full object-contain hover:scale-105 transition-transform duration-300 shadow-[0_15px_40px_rgba(99,102,241,0.4)] rounded-xl"
                  />
                  <div className="absolute inset-0 bg-gradient-to-t from-slate-950/80 to-transparent opacity-0 group-hover:opacity-100 transition-opacity rounded-xl flex items-end p-4">
                    <span className="text-white font-bold text-sm">Power Cards</span>
                  </div>
                </div>
                <div className="relative group">
                  <img
                    src="/Volcanix Lava v1.png"
                    alt="Volcanix Lava Anomaly"
                    className="w-full h-full object-contain hover:scale-105 transition-transform duration-300 shadow-[0_15px_40px_rgba(99,102,241,0.4)] rounded-xl"
                  />
                  <div className="absolute inset-0 bg-gradient-to-t from-slate-950/80 to-transparent opacity-0 group-hover:opacity-100 transition-opacity rounded-xl flex items-end p-4">
                    <span className="text-white font-bold text-sm">Game Changers</span>
                  </div>
                </div>
              </div>
            </div>
        ...
        <section className="content-section min-h-[90svh] flex flex-col items-center justify-center text-center py-16 md:py-20">
           <div className="max-w-4xl w-full backdrop-blur-2xl bg-indigo-950/10 p-8 sm:p-12 md:p-16 lg:p-20 rounded-3xl md:rounded-[3rem] lg:rounded-[5rem] border-2 border-white/10 shadow-[0_0_120px_rgba(99,102,241,0.2)] relative overflow-hidden">
            ...
            <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 justify-center items-center relative z-10">
              ...
              <PrimaryButton href="/how-to-play" variant="secondary" className="w-full sm:w-auto text-lg sm:text-xl md:text-2xl px-8 sm:px-10 md:px-12 py-4 sm:py-5 md:py-7 rounded-2xl sm:rounded-[2rem] border-white/20 hover:bg-white/10">
                SEE THE RULES
              </PrimaryButton>
            </div>
          </div>
